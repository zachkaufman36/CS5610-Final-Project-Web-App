...
export default function QuizEditor({ cid }: { cid: string }) {
    const { qid } = useParams();
        ...
        <div id="wd-quizzes-editor">
            <Form.Group as={Row} controlId="quiz-name" id="wd-name" className="mb-3">
                ...
                <Col sm={12}>
                    <FormControl
                        type="quiz-name"
                        defaultValue={filteredQuizzes[0].title}
            ...
            <Form.Group as={Row} controlId="quiz-description" id="wd-description" className="mb-3">
                ...
                <Col sm={12}>
                    <FormControl
                        ...
                        defaultValue="Please enter assignment description here..."
                    />
                </Col>
            </Form.Group>
            ...
            >
                ...
                <Col sm="9">
                    <FormControl
                        type="point-entry"
                        defaultValue={filteredQuizzes[0].points}
            ...
            >
                ...
                <Col sm={9}>
                    <Form.Select>
                        ...
                        <option selected value="PRACTICE QUIZ">
                            PRACTICE QUIZ
                        </option>
                        <option selected value="GRADED SURVEY">
                            GRADED SURVEY
                        </option>
                                ...
                                >
                                    ...
                                    <div className="d-flex align-items-center">
                                        <FormControl
                                            ...
                                            className="me-1"
                                        />
                                        <Form.Label htmlFor="time-box" className="mb-0">
                                            Minutes
                                        </Form.Label>
                                    </div>
                                </Form.Group>
                                ...
                                >
                                    ...
                                    <div className="d-flex align-items-center">
                                        <FormControl
                                            ...
                                            className="me-1"
                                        />
                                        <Form.Label htmlFor="wd-code" className="mb-0">
                    ...
                    <Form.Group className="editor-border">
                        ...
                        >
                            ...
                            <Col sm={12}>
                                <FormControl
                                    type="datetime"
                                    defaultValue={filteredQuizzes[0].due_date}
                                    onChange={(e) => setQuizDd(e.target.value)}
                                />
                            </Col>
                                ...
                                <Row>
                                    <Col md={6}>
                                        ...
                                        >
                                            ...
                                            <FormControl
                                                type="datetime"
                                                defaultValue={filteredQuizzes[0].release_date}
                                                onChange={(e) => setQuizRd(e.target.value)}
                                            />
                                        </Form.Group>
                                    </Col>
                                    <Col md={6}>
                                        <Form.Group
                                            controlId="available-until-date"
