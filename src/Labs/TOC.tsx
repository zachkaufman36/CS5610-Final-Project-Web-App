...
export default function TOC() {
  const { pathname } = useLocation();
    return (
     ...
     <Nav.Item>
       <Nav.Link as={Link} to="/Labs/Lab4" id="wd-a3" active={pathname.includes("Lab4")}>Lab 4</Nav.Link>
     </Nav.Item>
     <Nav.Item>
       <Nav.Link as={Link} to="/Labs/Lab5" id="wd-a3" active={pathname.includes("Lab5")}>Lab 5</Nav.Link>
     </Nav.Item>
     <Nav.Item>
